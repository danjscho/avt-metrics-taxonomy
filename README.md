...
**221 metrics across 20 groups**, covering the full AVT pipeline from audio capture to downstream write-back, plus governance, human factors, equity, and meta-evaluation. **AI-coauthored prototype for discussion — v4.2.1, 2026-05-03.** Shared to provoke conversation; not a settled standard.
...
**Current prototype version:** v4.2.1, released 2026-05-03.
...
> Schofield, D. (2026). *AVT Metrics Taxonomy v4.2.1* [prototype-for-discussion]. Retrieved from https://danjscho.github.io/avt-metrics-taxonomy/
...
*Last updated: v4.2.1 / 2026-05-03.*
